      ...
      <footer className="footer">
        <div className="row ">
          <div className="col-lg-2 col-md-2 col-12">
            ...
            <div className="mt-2">Startseite</div>
            <div className="mt-3">Startseite</div>
            <div className="mt-3">Startseite</div>
            <div className="mt-3">Startseite</div>
            <div className="mt-3">Startseite</div>
            <div className="mt-3">Startseite</div>
          ...
          <div className="col-lg-6 col-md-6 col-12">
            ...
            <div>CONTAINER UND MOBILE RAUMSYSTEME</div>
            <p>Die Conliving GmbH bietet zahlreiche Containerarten und Containeranlagen an. Von Wohn – und Bürocontainern bis zu Sanitär – und Baustellencontainern, bieten wir eine umfangreiche Auswahl an Containern an. Sie können Container kaufen oder auch mieten. Wählen Sie dafür einfach eins unserer Conliving Pakete aus.</p>
          </div>
        </div>
      </footer>
    </>
