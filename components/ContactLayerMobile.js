        ...
        <div >
            <div >
                <ul className='stCoBtnMo footerdisMo'>
                    <li>
                        <a href="mailto:info@containhaus.de" className='floatemailMobil  sm-mb20'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-light bi bi-telephone-fill" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="tel:+4923028894880" className='floatingbuttonnnnMobil'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-white bi bi-envelope-fill" viewBox="0 0 16 16">
